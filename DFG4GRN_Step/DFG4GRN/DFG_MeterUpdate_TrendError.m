...
[eTrendSign, eTrendR2, dX, dXstar] = DFG_TrendError(z, zOut, dYmean, indVars);

%Jac (I added more fields in the array output above)
global MODEL
MODEL{model_num}.dynamic.dYbestpred = dXstar
MODEL{model_num}.dynamic.dYTest = dX
MODEL{model_num}.dynamic.Ypred_all = zOut
%end Jac
...
[eTrendSign, eTrendR2, dX_all, dXstar_all] = DFG_TrendError(z, zOut, dYmean, []);

%Jac (I added more fields in the array output above)
global MODEL
MODEL{model_num}.dynamic.dYbestpred_all = dXstar_all
MODEL{model_num}.dynamic.dYTest_all = dX_all
%end Jac
